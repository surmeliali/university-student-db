...
<html>
<head>
	<title>Insert Data Into College Table</title>
...
try {
	$sql="INSERT INTO College VALUES (:colid, :colname, :colloc);";  
	$stmnt = $conn->prepare($sql);   
	$stmnt->bindParam(':colid', $_POST['College_ID']);
	$stmnt->bindParam(':colname', $_POST['College_Name']);   
...
echo "<a href='../../html_Insert/insertData.html'>Return to Add Data Page</a> <br />";
